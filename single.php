  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        ...
        <p class="text-white link-nav"><a href="<?php echo home_url(); ?>">Home </a>  <span class="lnr lnr-arrow-right"></span>
...
<!--              <img class="img-fluid" src="--><?php //echo P_IMG_DIR ?><!--blog/feature-img1.jpg" alt="">-->
        ...
        <div class="col-lg-3  col-md-3 meta-details">
          ...
          <div class="user-details row">
            ...
            <p class="date col-lg-12 col-md-12 col-6"><a href="#"><?php echo get_the_date(); ?></a> <span class="lnr lnr-calendar-full"></span></p>
        ...
        <div class="col-lg-9 col-md-9">
          <h3 class="mt-20 mb-20"><?php the_title(); ?></h3>
          <?php the_content(); ?>
        </div>
        <div class="col-lg-12">
          <div class="quotes">
